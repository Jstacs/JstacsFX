...
/**
 * Abstract class for providing a default implementation of {@link ParameterRenderer#render(Parameter, Pane, ToolReady)} that renders
...
public abstract class AbstractParameterRenderer<T extends Parameter> implements ParameterRenderer<T> {
	 ...
	 * @param name the name label that has been created by {@link AbstractParameterRenderer#render(Parameter, Pane, ToolReady)}
	 * @param comment the comment label that has been created by {@link AbstractParameterRenderer#render(Parameter, Pane, ToolReady)}
	 * @param error the error label that has been created by {@link AbstractParameterRenderer#render(Parameter, Pane, ToolReady)}
